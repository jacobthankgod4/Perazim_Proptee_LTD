...
foreach ($r51 as $fetch_array) {  
    ...
    $fetch_array_name[$count_fetch_proptee]=$fetch_array['Name'];
...
$dbDate[$count_fetch_proptee] = new DateTime($fetch_array_start[$count_fetch_proptee]);
    ...
    $interest_build_up[$count_fetch_proptee]=($fetch_array_share_cost[$count_fetch_proptee]*(2.5/100));

    $interest_build_up_fee+=$interest_build_up[$count_fetch_proptee];
