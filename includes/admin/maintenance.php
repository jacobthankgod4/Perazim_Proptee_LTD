...
<hr>
<div class="container">
<span class="site-title-tagline" style="color:#0e2e50 !important;font-size:12px;">Maintenance Fee </a> <img src="i/eye1.png" alt="" width="20px" height="auto"></span>
<!-- <li class="active">Dashboard</li> -->

<h2 class="site-title" style="font-size:42px;">₦<?=number_format($interest_build_up_fee, 2)?></h2>
...
<div class=" col-3 mt004" >
    ...
    <div class="pagin col-lg-12">
        ...
        <td>
        <h6 class="fw-bold">₦<?=$interest_build_up[$countDown] ?></h6>
